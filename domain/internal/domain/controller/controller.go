...
type sourceRepo interface {
	InsertSource(ctx context.Context, s model.SourceDao) error
	...
	ListSources(ctx context.Context, userID int64, roleIDs []int64) ([]model.SourceDao, error)
}

// SourceController implements source methods on logic layer.
...
// NewSourceController creates new SourceController.
func NewSourceController(ctx context.Context, sr sourceRepo, tracer trace.Tracer, producer *kafka.AsyncProducer, consumer *kafka.Consumer) (*SourceController, error) {
