...
type Entity interface {
	site.Site | site.Page | document.Document | object_store.ObjectStore | object_store.Object | file.File
}
...
type FileJob = DelayedJob[file.File]
type FileResultJob = DelayedJob[file.File]
