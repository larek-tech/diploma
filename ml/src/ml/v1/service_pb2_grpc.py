...
class MLServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessScenario = channel.unary_unary(
            "/pb.ml.MLService/ProcessScenario",
            request_serializer=ml_dot_v1_dot_model__pb2.ProcessScenarioRequest.SerializeToString,
            response_deserializer=ml_dot_v1_dot_model__pb2.ProcessScenarioResponse.FromString,
            _registered_method=True,
        )
...
class MLServiceServicer(object):
    ...
    def ProcessScenario(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
...
def add_MLServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "ProcessScenario": grpc.unary_unary_rpc_method_handler(
            servicer.ProcessScenario,
            request_deserializer=ml_dot_v1_dot_model__pb2.ProcessScenarioRequest.FromString,
            response_serializer=ml_dot_v1_dot_model__pb2.ProcessScenarioResponse.SerializeToString,
        ),
    }
...
class MLService(object):
    ...
    def ProcessScenario(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/pb.ml.MLService/ProcessScenario",
            ml_dot_v1_dot_model__pb2.ProcessScenarioRequest.SerializeToString,
            ml_dot_v1_dot_model__pb2.ProcessScenarioResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
