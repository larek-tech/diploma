...
class RAGPipeline:
    ...
    async def _prepare_chunks(
        ...
        with tracer.start_span(
            ...
            span.set_attribute("model", request.scenario.model.modelName)
            span.set_attribute("sourceIds", str(request.sourceIds))
            span.set_attribute("query", request.query.content)
