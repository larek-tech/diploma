...
const (
	...
	ChatService_DeleteChat_FullMethodName       = "/chat.v1.ChatService/SoftDeleteChat"
...
func (UnimplementedChatServiceServer) DeleteChat(context.Context, *DeleteChatRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SoftDeleteChat not implemented")
}
